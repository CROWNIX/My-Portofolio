          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            <div className="flex items-center">
              <a
                ...
                target="_blank"
                className="mr-3 flex h-9 w-9 items-center justify-center rounded-full border  text-white bg-youtube border-slate-300" rel="noreferrer"
              >
              ...
              <a
                ...
                target="_blank"
                className="mr-3 flex h-9 w-9 items-center justify-center rounded-full border  text-slate-300 instagram" rel="noreferrer"
              >
                <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a
                ...
                target="_blank"
                className="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-white hover:border-tiktok bg-tiktok " rel="noreferrer"
              >
                <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <title>TikTok</title>
                  <path
              ...
              <a
                ...
                target="_blank"
                className="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-white hover:border-linkedin bg-linkedin" rel="noreferrer"
              >
                <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
