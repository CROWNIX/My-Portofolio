            ...
            <div className='container'>
                ...
                <div className='flex w-full flex-wrap justify-center px-4 xl:mx-auto xl:w-10/12'>
                    <div className='mb-12 p-4 md:w-1/2'>
                        <div className="overflow-hidden rounded-md shadow-md relative before:content-['<span'] before:opacity-0 md:before:opacity-70 sm:before:absolute before:w-full before:top-o before:h-full before:bg-black before:-translate-y-full hover:before:-translate-y-0 before:duration-300 group">
                            <div className='hidden md:flex absolute w-full h-full justify-center items-center -translate-y-full group-hover:-translate-y-0 duration-300'>
                                <a href='www.youtube.com' className='px-5 py-2 text-white border border-slate-200 rounded-lg hover:bg-primary transition duration-500' target='_blank'>
                                    Preview
                                </a>
                            </div>
                        ...
                        <h3 className='mt-5 mb-2 text-xl font-semibold text-dark dark:text-white'>Landing Page Sandhika Galih</h3>
                        <span className='text-base font-normal text-gray-600'>2 Days Ago</span>
                        <p className='text-base font-medium text-secondary mb-5 mt-4'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius, iusto! Aliquam, corporis.</p>
                        <a href='www.youtube.com' className='w-[44px] h-[44px] px-5 py-3 text-base font-semibold text-white rounded-lg bg-primary transition duration-500 hover:opacity-80' target='_blank'>
                            Preview
                        </a>
                    </div>
                    <div className='mb-12 p-4 md:w-1/2'>
                    ...
                    <div className='mb-12 p-4 md:w-1/2'>
                        <div className="overflow-hidden rounded-md shadow-md relative before:content-['<span'] before:opacity-0 md:before:opacity-70 sm:before:absolute before:w-full before:top-o before:h-full before:bg-black before:-translate-y-full hover:before:-translate-y-0 before:duration-300 group">
                            <div className='hidden md:flex absolute w-full h-full justify-center items-center -translate-y-full group-hover:-translate-y-0 duration-300'>
                                <a href='www.youtube.com' className='px-5 py-2 text-white border border-slate-200 rounded-lg hover:bg-primary duration-300' target='_blank'>
                                    Preview
                                </a>
                            </div>
                        ...
                        <h3 className='mt-5 mb-3 text-xl font-semibold text-dark dark:text-white'>Landing Page Sandhika Galih</h3>
                        <span className='text-base font-normal text-gray-600'>2 Days Ago</span>
                        <p className='text-base font-medium text-secondary mb-5 mt-4'>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius, iusto! Aliquam, corporis. Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo, voluptate.
                        </p>
                        <a href='www.youtube.com' className='w-[44px] h-[44px] px-5 py-3 text-base font-semibold text-white rounded-lg bg-primary transition duration-500 hover:opacity-80' target='_blank'>
                            Preview
                        </a>
