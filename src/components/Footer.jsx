            ...
            <div className='container'>
                <div className='flex flex-wrap'>
                    <div className='mb-12 w-full px-4 font-medium text-slate-300 md:w-1/3'>
                        <h3 className='mb-5 text-xl font-semibold text-white'>Contact Me</h3>
                ...
                <div className='w-full border-t border-slate-700 pt-10'>
                    <div className='mb-5 flex items-center justify-center'>
                        <a href='https://www.instagram.com/rahmatfauzi.w/' target='_blank' className='mr-3 flex h-9 w-9 items-center justify-center rounded-full border  text-slate-300 instagram' rel='noreferrer'>
                        ...
                        <a href='https://github.com/CROWNIX' target='_blank' className='mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-white  bg-dark' rel='noreferrer'>
                            <svg role='img' width='20' className='fill-current' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                                <title>GitHub</title>
